...
app.doc("/openapi.json", {
    ...
    info: {
        ...
        version: "1.0.0",
        description:
            "Public REST API gateway for Easypanel v2.26.3 — translates REST endpoints into internal tRPC calls. " +
            "Extracted from the real Easypanel Docker image.",
        license: { name: "MIT" },
    },
    servers: [
...
app.openAPIRegistry.registerComponent("securitySchemes", "Bearer", {
    type: "http",
    scheme: "bearer",
    bearerFormat: "ez-token",
    description:
        "Easypanel session token. Get one by calling POST /auth/login with your admin email and password.",
});
...
console.log(`
╔══════════════════════════════════════════════════╗
║      Easypanel API Gateway v1.0.0 (v2.26.3)      ║
╠══════════════════════════════════════════════════╣
